---
title: 'A glimpse into the education levels: Democrats vs Republicans'
author: "WendyD"
date: "9/21/2020"
output:
...
The data I used for this report comes from American National Election Studies(ANES). The original data has 1029 variables. To make thing easier, I subsetted the data by variables of interest, and saved it as data1
...
Connecting this to our previous finding, that higher educated voters prefer republicans, the word cloud plots make total sense. People who have lower income , correlated with less educated background. These people choose Democrats because the party offer a superior group connection quality, with a promise of equal pay, higher tax on the rich, and most importantly, inclusivity for the poor. The voters who have higher education, enjoyed a higher pay positions, want to maintain their social status, so they resonance more with the Republican's conservative philosophy. These voters place an emphasis on the party's management skill in preserving the rich's benefits. 

# Why Donald Trump win? Does his agenda make sense?

I looked at the voter's feeling thermoemter toward Democratic party across the years, and 2016 specifically: 
...
p1 <- ggplot(data3, aes(x=V3, y=V2))+xlab("Education Levels")+ylab("Thermometer level")+
  ...
  scale_x_discrete(labels = c("Grade school", "High school", "Some College", "College degree"), guide=guide_axis(n.dodge = 3)) 
